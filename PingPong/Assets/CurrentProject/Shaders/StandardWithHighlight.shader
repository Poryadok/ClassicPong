...
Shader "Custom/StandardWithHighlight"
{
    Properties
    {
        ...
        _HitDistance("Hit Distance", Range(0.0, 2.0)) = 0.5
        _HighlightDuration("Highlight Duration", Range(0.0, 2.0)) = 0.2
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float _HighlightDuration;
            ...
            struct VertexOutputForward
            {
                ...
                float hitDistance                     : TEXCOORD7;
                float3 posWorld                     : TEXCOORD8;
            };
            
            
            #include "UnityStandardCore.cginc"
            VertexOutputForward vertNew (VertexInput v)
            {
                ...
                const float4 hitPosition = float4(_HitPosition.rgb, 1);

                o.hitDistance =  distance(v.vertex, hitPosition);
            ...
            half4 fragNew (VertexOutputForward i) : SV_Target
            {
                    ...
                    if (_Time[1] - _HitTime < _HighlightDuration && i.hitDistance < _HitDistance)
                        s.diffColor = _HighlightColor;
